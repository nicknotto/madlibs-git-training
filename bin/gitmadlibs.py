...
class MadLib(object):
    ...
    def print_result(self):
        ...
        try:
            ...
            raise AssertionError("You should run get_inputs() first!" + e)
...
class Patch(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Patch",
                               ...
                               "with such patches usually being called {noun2} fixes, and improving the functionality, {noun3}"
                               "or performance.\n\nPatching makes possible the modification of compiled and machine language"
                               "object programs when the source code is {adj1}. This demands a thorough understanding of the"
                               "inner workings of the object code by the person creating the patch, which is difficult without"
                               "close study of the source code. For minor changes to software, it is often easier and more"
                               "economical to distribute patches to users rather than redistributing a newly recompiled or"
                               "reassembled program.\n\nAlthough meant to fix problems, poorly designed patches can sometimes"
                               "introduce {adj2} problems (see software regressions). In some special cases updates may"
                               "knowingly break the {noun4} or disable a device, for instance, by removing components for"
                               "which the update provider is no longer licensed.\n\n\n"])
...
class AntiPattern(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Anti-pattern",
                               ...
                               "software design to refer informally to any commonly reinvented but {adj2} solution to a"
                               "problem. Examples include analysis paralysis, cargo cult {noun2}, death march, groupthink and"
                               "vendorlock-in.\n\n\n"])
