...
__license__ = "All self._text is based on wikipedia using Creative Commons Attribution-ShareAlike 3.0 Unported License." \
              "All else GPL."
__version__ = "0.1.0"
    ...
    def print_result(self):
        ...
        try:
            if self._inputs["complete"] == "yes":
                print(parawrap.fill(self._text.format(**self._inputs)))
                print(("_"*93)[:93] + "\n")
        except Exception:
...
class Patch(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Patch",
                               ...
                               "update, {verb}, or improve it. This includes fixing {noun1} vulnerabilities and other bugs,",
                               "with such patches usually being called {noun2} fixes, and improving the functionality,",
                               "{noun3} or performance.\n\nPatching makes possible the modification of compiled and machine",
                               "language object programs when the source code is {adj1}. This demands a thorough",
                               "understanding of the inner workings of the object code by the person creating the patch,",
                               "which is difficult without close study of the source code. For minor changes to software, it",
                               "is often easier and more economical to distribute patches to users rather than",
                               "redistributing a newly recompiled or reassembled program.\n\nAlthough meant to fix problems,",
                               "poorly designed patches can sometimes introduce {adj2} problems (see software regressions).",
                               "In some special cases updates may knowingly break the {noun4} or disable a device, for",
                               "instance, by removing components for which the update provider is no longer licensed.\n\n\n"])
...
class BillGates(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Bill Gates",
                               ...
                               "Albuquerque, New Mexico; it went on to become the world's {adj} personal computer software",
                               "company.\n\n\n"])
...
class Bitcoin(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Bitcoin",
                               ...
                               "started in 2009 when its source code was {verb2} as open-source software. Bitcoins are",
                               "{verb3} as a reward for a process known as {verb_ending_in_ing}. They can be exchanged for",
                               "other currencies, {plural_noun2}, and services.\n\n\n"])
...
class DataBreach(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Data Breach",
                               ...
                               "private/confidential {noun1} to an untrusted {noun2}. Other terms for this phenomenon include",
                               "{adj1} {noun3} disclosure, data leak, information leakage and also {noun4} spill. Incidents",
                               "range from concerted attacks by black hats, or individuals who hack for some kind of {adj2}",
                               "gain, associated with organized crime, political activists or {adj3} governments to careless",
                               "disposal of used computer equipment or data storage media and unhackable source.\n\nData",
                               "breaches may involve financial information such as credit card or bank details, personal",
                               "health information (PHI), Personally identifiable information (PII), {adj4} secrets of",
                               "corporations or {adj5} property. Most data breaches involve overexposed and vulnerable",
...
class AntiPattern(MadLib):
    def __init__(self):
        ...
        self._text = " ".join(["Anti-pattern",
                               ...
                               "a book, {noun1} Patterns, which highlights a number of design patterns in software",
                               "development that its authors considered to be highly reliable and effective.\n\nThe term was",
                               "popularized {number} years later by the book AntiPatterns, which extended its use beyond the",
                               "field of software design to refer informally to any commonly reinvented but {adj2} solution",
                               "to a problem. Examples include analysis paralysis, cargo cult {noun2}, death march,",
                               "groupthink and vendorlock-in.\n\n\n"])


if __name__ == '__main__':
    num = 0
    madlibs = [TechnologyAdoptionLifecycle(), TechnologyEvangelist(), TechnologyEvangelist2(), TheInternet(), TheInternet2(),
               AI(), ReverseEngineeringOfSoftware(), Patch(), BillGates(), InternetTroll(), Bitcoin(), DataBreach(),
               AntiPattern()]
